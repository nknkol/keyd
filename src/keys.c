...
const struct keycode_table_ent keycode_table[512] = {
	...
	[KEYD_BOOKMARKS] = { "favorites", "bookmarks", NULL },
	...
	[KEYD_F21] = { "f21", "prog1", NULL },
	[KEYD_F22] = { "f22", "prog2", NULL },
	[KEYD_F23] = { "f23", "prog3", NULL },
	[KEYD_F24] = { "f24", "prog4", NULL },
	[KEYD_PLAYCD] = { "playcd", NULL, NULL },
	[KEYD_PAUSECD] = { "pausecd", NULL, NULL },
	[KEYD_SCROLL_RIGHT] = { "scrollright", NULL, NULL },
	[KEYD_SCROLL_LEFT] = { "scrollleft", NULL, NULL },
